        ...
        <article class="md:flex">
            ...
            <div class="w-full bg-white rounded-lg sahdow-lg overflow-hidden flex flex-col md:flex-row">
                <div class="w-full  h-80">
                    <img class="object-center object-cover w-72 h-80 " src="{{ $creator->user->profile_photo_url}}" alt="photo">
                </div>
                <div class="w-full md:w-3/5 text-left p-6 md:p-4 space-y-2">
                    <p class="text-xl text-gray-700 font-bold">{{$creator->user->name}}</p>
                    <p class="text-base text-gray-400 font-normal">{{ $creator->user->pais->name ?? '-'}}</p>
                    <p class="text-base leading-relaxed text-gray-500 font-normal">{{$creator->user->biografia}}</p>
