<div>
    <div class="flex w-full flex-row items-center gap-2 rounded-[99px] border border-gray-900/10 bg-gray-900/5 mt-2">
        <div>
         
           {{-- <button
            class="relative h-6 max-h-[40px] w-10 max-w-[40px] select-none rounded-full text-center align-middle font-sans text-xs font-medium uppercase text-gray-900 transition-all hover:bg-gray-900/10 active:bg-gray-900/20 disabled:pointer-events-none disabled:opacity-50 disabled:shadow-none"
            type="button">
       
              <svg width="16" class="ml-2.5" height="16" viewBox="0 0 14 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path
        ...
        <div class="relative grid h-full w-full min-w-[200px]">
          <textarea rows="1" placeholder="Agrega un comentario" name="comentario" wire:model="comentario" type="text"
            class="peer  min-h-full w-full resize-y rounded-[7px] !border-0 border-blue-gray-200 border-t-transparent bg-transparent px-1 font-sans text-sm font-normal text-blue-gray-700 outline outline-0 transition-all placeholder:text-blue-gray-300 placeholder-shown:border placeholder-shown:border-blue-gray-200 placeholder-shown:border-t-blue-gray-200 focus:border-2 focus:border-gray-900 focus:border-transparent focus:border-t-transparent focus:outline-0 disabled:resize-none disabled:border-0 disabled:bg-blue-gray-50"></textarea>
        ...
        <div>
          ...
          <button
            ...
            type="button"  wire:click="comentar">
      ...
      <link rel="stylesheet" href="{{ asset('vendor/emojione/emojionearea.min.css') }}">

      <script type="text/javascript" src="{{ asset('vendor/emojione/emojionearea.min.js') }}"></script>
